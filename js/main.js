...
var $proofString = document.getElementById('proofString')
...
var $leaveSelect = $('#leaveSelect');
var $statusCopyLabel = $('#statusCopy');
...
function setProofString (value) {
  $proofString.textContent = value
}
function setStatusLabel (value) {
  $statusCopyLabel.text(value);
  $statusCopyLabel.css("color", "#000000");
}
...
$leaveSelect.on('change', function (event) {
  event.preventDefault()
